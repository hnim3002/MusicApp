...
public class LibraryPlaylistAdapter extends RecyclerView.Adapter<LibraryPlaylistAdapter.SearchPlaylistViewHolder> {
    ...
    public LibraryPlaylistAdapter(List<Item> mItemArtist, Context mContext, IClickItemListener iClickItemListener) {
    ...
    @NonNull
    @Override
    public LibraryPlaylistAdapter.SearchPlaylistViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public class SearchPlaylistViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener {
